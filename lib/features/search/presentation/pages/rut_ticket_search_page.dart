...
import 'package:tocke/features/scanner/presentation/pages/ticket_confirmation_page.dart';

class RutTicketSearchPage extends StatefulWidget {
  final RutTicketSearchService searchService;

  const RutTicketSearchPage({super.key, required this.searchService});

  @override
  State<RutTicketSearchPage> createState() => _RutTicketSearchPageState();
}

class _RutTicketSearchPageState extends State<RutTicketSearchPage> {
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Busca tickets del participante en todos los eventos del organizador.',
                    ...
                    _results.isEmpty
                        ? Center(
                          child: Text(
                            _isLoading
                                ? ''
                                : 'Sin resultados por ahora. Busca un documento para listar tickets.',
                              ...
                              child: InkWell(
                                ...
                                onTap: () {
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder:
                                          (context) => TicketConfirmationPage(
                                            initialTicket:
                                                item.toValidationResult(),
                                          ),
                                    ),
                                  );
                                },
